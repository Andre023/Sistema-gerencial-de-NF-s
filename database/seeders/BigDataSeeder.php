...
class BigDataSeeder extends Seeder
{
    ...
    private function seedFornecedores(): array
    {
        ...
        $nomes = [
            ...
            'Alimentos Nu S/A', 'Doces Xi ME', 'Biscoitos Omicron Ltda',
            'Massas Pi Indústria', 'Grãos Rho Comércio', 'Temperos Sigma ME',
            'Conservas Tau Ltda', 'Bebidas Upsilon S/A', 'Laticínios Phi Comércio',
            'Rações Chi Distribuidora', 'Embutidos Psi Ltda', 'Frios Omega S/A',
            'Distribuidora Norte ME', 'Atacado Sul Ltda', 'Comércio Leste S/A',
            ...
            'Biscoitos Alegria ME', 'Temperos do Sul Ltda', 'Mercearia Boa Vista S/A',
            'Frigorífico São Paulo ME', 'Distribuidora Rio Ltda', 'Comércio Minas S/A',
            'Alimentos Bahia ME', 'Bebidas Pernambuco Ltda', 'Laticínios Goiás S/A',
            'Cerealista Paraná ME', 'Grãos Santa Catarina Ltda', 'Frios Rio Grande S/A',
            'Embutidos Nordeste ME', 'Carnes Centro-Oeste Ltda', 'Doces Sudeste S/A',
            'Massas Norte ME', 'Temperos Brasil Ltda', 'Conservas Nacional S/A',
            'Hortifruti Premium ME', 'Biscoitos Gourmet Ltda', 'Condimentos Select S/A',
            'Bebidas Especiais ME', 'Laticínios Artesanais Ltda', 'Frigorífico Rural S/A',
            'Distribuidora Campo ME', 'Comercial Fazenda Ltda', 'Alimentos Serra S/A',
            'Cerealista Vale ME', 'Grãos Planalto Ltda', 'Frios Litoral S/A',
            'Embutidos Sertão ME', 'Carnes Pantanal Ltda', 'Doces Cerrado S/A',
            'Massas Amazônia ME', 'Temperos Caatinga Ltda', 'Conservas Pampa S/A',
            'Hortifruti Mata ME', 'Biscoitos Chapada Ltda', 'Condimentos Mangue S/A',
            'Bebidas Pantaneira ME', 'Laticínios Gaúcha Ltda', 'Frigorífico Mineiro S/A',
            'Distribuidora Paulista ME', 'Comercial Carioca Ltda', 'Alimentos Nordestina S/A',
            'Cerealista Baiana ME', 'Grãos Pernambucana Ltda', 'Frios Cearense S/A',
            'Embutidos Maranhense ME', 'Carnes Piauiense Ltda', 'Doces Alagoana S/A',
            'Massas Sergipana ME', 'Temperos Paraibana Ltda', 'Conservas Potiguar S/A',
            'Hortifruti Capixaba ME', 'Biscoitos Fluminense Ltda', 'Condimentos Bonaerense S/A',
            'Bebidas Catarina ME', 'Laticínios Gaúcha Premium Ltda', 'Frigorífico Mato-Grossense S/A',
            'Distribuidora Goiana ME', 'Comercial Tocantinense Ltda', 'Alimentos Acreana S/A',
            'Cerealista Amapaense ME', 'Grãos Roraimense Ltda', 'Frios Paraense S/A',
            'Embutidos Amazonense ME', 'Carnes Rondoniense Ltda', 'Doces Sul-Mato-Grossense S/A',
        ];
